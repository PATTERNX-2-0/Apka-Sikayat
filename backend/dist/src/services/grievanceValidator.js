...
exports.validateGrievance = validateGrievance;
const SYSTEM_PROMPT = `
...
`;
async function callGemini(model, base64Image, mimeType, contextText) {
...
async function validateGrievance(image, title, description, category, district) {
    if (!image) {
