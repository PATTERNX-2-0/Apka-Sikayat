...
import { Layers, BarChart3, ArrowRight, MapPin, Menu, X, Building2 } from 'lucide-react';
import LanguageSwitcher from '@/components/LanguageSwitcher'; // <-- Updated to the sleek custom UI
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            >
              ...
              {/* === THE NEW SLEEK TRANSLATE WIDGET GOES HERE === */}
              <div className="border-l border-gray-300 pl-8 flex items-center">
                <LanguageSwitcher />
              </div>

              <Link href="/login?type=citizen" className="hover:text-[#1E3A8A] transition-colors ml-2">Sign In</Link>
            ...
            <div className="md:hidden flex items-center space-x-4">
              {/* Translate Widget on Mobile (Visible before opening menu) */}
              <LanguageSwitcher />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-full bg-white shadow-md border border-gray-100 overflow-hidden flex items-center justify-center p-0.5">
              <img src="/logo.jpeg" alt="Logo mini" className="w-full h-full object-contain rounded-full" />
            </div>
